...
//        }
    ...
    public static class AliDisplayText implements AliTextDisplay {
        ...
        public AliDisplayText(List<Player> players, Location location, float yaw, float pitch, v1_21_R7 manager){
...
//            manager.sendPacket(players, teleport);
    ...
    public static class AliDisplayItem implements AliItemDisplay {
        ...
        public AliDisplayItem(List<Player> players, Location location, float yaw, float pitch, v1_21_R7 manager){
            this.manager = manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
...
//            manager.sendPacket(players, teleport);
    ...
    public static class ShulkerAli implements AliShulker {
        ...
        public ShulkerAli(List<Player> players, Location location, float yaw, float pitch, v1_21_R7 manager){
            this.manager = manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
    ...
    public static class AliDisplayBlock implements AliBlockDisplay {
        ...
        public AliDisplayBlock(List<Player> players, Location location, float yaw, float pitch, v1_21_R7 manager) {
            this.manager = manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
