...
public class v1_20_R2 implements Compat {
    ...
    public static class AliDisplayText implements AliTextDisplay {
        ...
        public AliDisplayText(List<Player> players, Location location, float yaw, float pitch, v1_20_R2 manager){
    ...
    public static class AliDisplayItem implements AliItemDisplay {
        ...
        public AliDisplayItem(List<Player> players, Location location, float yaw, float pitch, v1_20_R2 manager){
            this.manager = manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
