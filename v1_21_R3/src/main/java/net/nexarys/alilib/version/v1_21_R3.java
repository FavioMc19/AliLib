...
public class v1_21_R3 implements Compat {
...
//        }
    ...
    public static class AliDisplayText implements AliTextDisplay {
        ...
        private final v1_21_R3 manager;

        public AliDisplayText(List<Player> players, Location location, float yaw, float pitch, v1_21_R3 manager){
            this.manager = manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
            this.textDisplay = new Display.TextDisplay(EntityTypes.bu, world);
            spawnPacket =  new PacketPlayOutSpawnEntity(manager.getEntityID(textDisplay), textDisplay.cG(), location.getX(), location.getY(), location.getZ(), yaw, pitch, textDisplay.aq(), 0, textDisplay.dy(), textDisplay.cA());
...
//            manager.sendPacket(players, teleport);
    ...
    public static class AliDisplayItem implements AliItemDisplay {
        ...
        public AliDisplayItem(List<Player> players, Location location, float yaw, float pitch, v1_21_R3 manager){
            this.manager = manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
