...
public class v1_20_R3 implements Compat {
    ...
    public static class AliDisplayText implements AliTextDisplay {
        ...
        public AliDisplayText(List<Player> players, Location location, float yaw, float pitch, Compat manager){
    ...
    public static class AliDisplayItem implements AliItemDisplay {
        ...
        public AliDisplayItem(List<Player> players, Location location, float yaw, float pitch, Compat manager){
            this.manager = (v1_20_R3) manager;
            this.players = players;
            this.location = location;
            WorldServer world = ((CraftWorld) Objects.requireNonNull(location.getWorld())).getHandle();
